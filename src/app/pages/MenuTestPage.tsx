              ...
              >
                <div className='menu-item me-lg-2'>
                  <a
                    ...
                    href='/Capricorn/products/themes/start/html/demo1/dist/?page=index'
                  >
                      ...
                      >
                        ...
                        <div className='menu-item'>
                          <a
                            ...
                            href='/Capricorn/products/themes/start/html/demo1/dist/?page=pages/profile/projects'
                          >
                            <span className='menu-bullet'>
                              <span className='bullet bullet-dot'></span>
                            </span>
                        ...
                        <div className='menu-item'>
                          <a
                            className='menu-link py-3'
                            href='/Capricorn/products/themes/start/html/demo1/dist/?page=pages/profile/campaigns'
                          >
                            <span className='menu-bullet'>
                              <span className='bullet bullet-dot'></span>
                            </span>
                        ...
                        >
                          ...
                          <div className='menu-sub menu-sub-accordion menu-sub-lg-dropdown menu-active-bg py-4 w-100 w-lg-225px'>
                            <div className='menu-item'>
                              <a
                                className='menu-link py-3'
                                href='/Capricorn/products/themes/start/html/demo1/dist/?page=pages/profile/overview'
                              >
                                <span className='menu-bullet'>
                                  <span className='bullet bullet-dot'></span>
                                </span>
                            ...
                            <div className='menu-item'>
                              <a
                                className='menu-link py-3'
                                href='/Capricorn/products/themes/start/html/demo1/dist/?page=pages/profile/documents'
                              >
                                <span className='menu-bullet'>
                                  <span className='bullet bullet-dot'></span>
                                </span>
                            ...
                            <div className='menu-item'>
                              <a
                                className='menu-link py-3'
                                href='/Capricorn/products/themes/start/html/demo1/dist/?page=pages/profile/followers'
                              >
                                <span className='menu-bullet'>
                                  <span className='bullet bullet-dot'></span>
                                </span>
                            ...
                            <div className='menu-item'>
                              <a
                                className='menu-link py-3'
                                href='/Capricorn/products/themes/start/html/demo1/dist/?page=pages/profile/activity'
                              >
                                <span className='menu-bullet'>
                                  <span className='bullet bullet-dot'></span>
                                </span>
                            ...
                            <div className='menu-item'>
                              <a
                                className='menu-link py-3'
                                href='/Capricorn/products/themes/start/html/demo1/dist/?page=pages/profile/dashboard'
                              >
                                <span className='menu-bullet'>
                                  <span className='bullet bullet-dot'></span>
                                </span>
                    ...
                    >
                      ...
                      <div className='menu-sub menu-sub-accordion menu-sub-lg-dropdown py-4 w-100 w-lg-225px'>
                        <div className='menu-item'>
                          <a
                            className='menu-link py-3'
                            href='/Capricorn/products/themes/start/html/demo1/dist/?page=pages/projects/overview'
                          >
                            <span className='menu-bullet'>
                              <span className='bullet bullet-dot'></span>
                            </span>
                        ...
                        <div className='menu-item'>
                          <a
                            className='menu-link py-3'
                            href='/Capricorn/products/themes/start/html/demo1/dist/?page=pages/projects/lists'
                          >
                            <span className='menu-bullet'>
                              <span className='bullet bullet-dot'></span>
                            </span>
                        ...
                        <div className='menu-item'>
                          <a
                            className='menu-link py-3'
                            href='/Capricorn/products/themes/start/html/demo1/dist/?page=pages/projects/activity'
                          >
                            <span className='menu-bullet'>
                              <span className='bullet bullet-dot'></span>
                            </span>
                        ...
                        <div className='menu-item'>
                          <a
                            className='menu-link py-3'
                            href='/Capricorn/products/themes/start/html/demo1/dist/?page=pages/projects/files'
                          >
                            <span className='menu-bullet'>
                              <span className='bullet bullet-dot'></span>
                            </span>
                        ...
                        <div className='menu-item'>
                          <a
                            className='menu-link py-3'
                            href='/Capricorn/products/themes/start/html/demo1/dist/?page=pages/projects/users'
                          >
                            <span className='menu-bullet'>
                              <span className='bullet bullet-dot'></span>
                            </span>
                        ...
                        <div className='menu-item'>
                          <a
                            className='menu-link py-3'
                            href='/Capricorn/products/themes/start/html/demo1/dist/?page=pages/projects/targets'
                          >
                            <span className='menu-bullet'>
                              <span className='bullet bullet-dot'></span>
                            </span>
                    ...
                    <div data-kt-menu-trigger='click' className='menu-item'>
                      ...
                      <div className='menu-sub menu-sub-accordion'>
                        <div className='menu-item'>
                          <a
                            className='menu-link py-3'
                            href='/Capricorn/products/themes/start/html/demo1/dist/?page=pages/wizards/wizard-vertical'
                          >
                            <span className='menu-bullet'>
                              <span className='bullet bullet-dot'></span>
                            </span>
                        ...
                        <div className='menu-item'>
                          <a
                            className='menu-link py-3'
                            href='/Capricorn/products/themes/start/html/demo1/dist/?page=pages/wizards/wizard-horizontal'
                          >
                            <span className='menu-bullet'>
                              <span className='bullet bullet-dot'></span>
                            </span>
                    ...
                    <div data-kt-menu-trigger='click' className='menu-item'>
                      ...
                      <div className='menu-sub menu-sub-accordion'>
                        <div className='menu-item'>
                          <a
                            className='menu-link py-3'
                            href='/Capricorn/products/themes/start/html/demo1/dist/?page=pages/search/search-horizontal'
                          >
                            <span className='menu-bullet'>
                              <span className='bullet bullet-dot'></span>
                            </span>
                        ...
                        <div className='menu-item'>
                          <a
                            className='menu-link py-3'
                            href='/Capricorn/products/themes/start/html/demo1/dist/?page=pages/search/search-vertical'
                          >
                            <span className='menu-bullet'>
                              <span className='bullet bullet-dot'></span>
                            </span>
                ...
                >
                  ...
                  >
                    <div className='menu-item'>
                      <a
                        className='menu-link py-3'
                        href='/Capricorn/products/themes/start/html/demo1/dist/?page=documentation/getting-started'
                      >
                        <span className='menu-icon'>
                          <span className=' fs-1'>
                            <SVG src={toAbsoluteUrl('/media/logos/default-small.svg')} />
                    ...
                    <div className='menu-item'>
                      <a
                        className='menu-link py-3'
                        href='/Capricorn/products/themes/start/html/demo1/dist/?page=layout-builder'
                      >
                        <span className='menu-icon'>
                          <span className=' fs-1'>
                            <SVG src={toAbsoluteUrl('/media/logos/default-small.svg')} />
                    ...
                    <div className='menu-item'>
                      <a
                        className='menu-link py-3'
                        href='/Capricorn/products/themes/start/html/demo1/dist/?page=documentation/getting-started/changelog'
                      >
                        <span className='menu-icon'>
                          <span className=' fs-1'>
                            <SVG src={toAbsoluteUrl('/media/logos/default-small.svg')} />
